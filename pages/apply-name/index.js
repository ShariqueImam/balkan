    ...
    <Animator>
      <div className={style.wrapper}>
        <section className="">
          ...
          {/* adding the button */}
          <Link href={!Error && Click ? "/apply-dob" : {}} className="flex">
            <p className="text-white transparent opacity-0">1</p>
            <AiOutlineArrowRight className="text-white text-lg mx-1 transparent opacity-0" />
            <button
              onClick={handleClick}
              className="flex items-center justify-center my-4 md:my-4 max-w-fit bg-gold px-4 md:px-6 py-2 md:py-3 text-white tracking-wider rounded hover:opacity-[0.9] transition duration-[300ms]"
            >
